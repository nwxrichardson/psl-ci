...
/**
 * This is the item provider adapter for a {@link psl.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PslPackage.Literals.TASK__TITLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PslPackage.Literals.TASK__START,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PslPackage.Literals.TASK__DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDependenciesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_dependencies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_dependencies_feature", "_UI_Task_type"),
				 PslPackage.Literals.TASK__DEPENDENCIES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PslPackage.Literals.TASK__EFFORT);
			childrenFeatures.add(PslPackage.Literals.TASK__DELIVERABLES);
		}
	...
	public String getText(Object object) {
		String label = ((Task)object).getTitle();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PslPackage.Literals.TASK__EFFORT,
				 PslFactory.eINSTANCE.createEffort()));

		newChildDescriptors.add
			(createChildParameter
				(PslPackage.Literals.TASK__DELIVERABLES,
				 PslFactory.eINSTANCE.createDeliverable()));
	}
